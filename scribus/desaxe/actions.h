...
protected:
	...
	virtual ~Action_body()                     {}
	virtual void begin(const std::string tag, std::map<std::string,std::string> attr) 
                                               {}
	virtual void end(const std::string tag)    {}
	virtual void chars(const std::string data) {}
...
public:
	...
	inline void begin(const std::string tag, std::map<std::string,std::string> attr) 
	                                           { body->begin(tag, attr); }
	inline void end(const std::string tag)     { body->end(tag); }
	inline void chars(const std::string data)  { body->chars(data); }
...
{
public:
	virtual Type* eval(Digester* dig_, std::string tag, std::map<std::string,std::string> attr)
	{
		dig = dig_;
		begin(tag, attr);
		Type* res;
...
protected:
	void end(const std::string tag) { dig->pop(); }
};
...
{
public:
	Type* eval(Digester* dig, std::string tag, std::map<std::string,std::string> attr)
	{
