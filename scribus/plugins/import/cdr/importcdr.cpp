...
bool CdrPlug::convert(QString fn)
{
	...
	if (ext == "cdr")
	{
		...
		if (!fail)
		{
			RawPainter painter(m_Doc, m_baseX, m_baseY, m_docWidth, m_docHeight, m_importerFlags, &m_Elements, &m_importedColors, &m_importedPatterns, m_tmpSel, "cdr");
	...
	else if (ext == "cmx")
	{
		...
		RawPainter painter(m_Doc, m_baseX, m_baseY, m_docWidth, m_docHeight, m_importerFlags, &m_Elements, &m_importedColors, &m_importedPatterns, m_tmpSel, "cmx");
