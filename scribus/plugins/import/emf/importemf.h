...
private:
	...
	QStack<dcState> m_dcStack;
	QHash<quint32, dcState> m_dcStackEMP;
	dcState m_currentDC;
	QHash<quint32, emfStyle> m_emfStyleMap;
	QHash<quint32, emfStyle> m_emfStyleMapEMP;
	QList<PageItem*> m_Elements;
	PageItem* m_clipGroup;
	double m_docWidth;
	double m_docHeight;
	...
	double m_dpiX;
	double m_dpiY;
	quint32 m_EmfPdpiX, m_EmfPdpiY;
	quint32 m_records;
	int m_recordCount;
	qint32 m_viewPextendX, m_viewPextendY;
	qint32 m_winPextendX, m_winPextendY;
	qint32 m_winOrigX, m_winOrigY;
	QRectF m_bBoxDev;
	QRectF m_bBoxMM;
	...
	bool m_emfPlusDual;
	bool m_emfMixed;
	float m_emfPlusScale;
	bool m_SerializableObject_Valid;
