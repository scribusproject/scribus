...
*/
#ifndef IMPORTVSDPLUGIN_H
#define IMPORTVSDPLUGIN_H
...
class PLUGIN_API ImportVsdPlugin : public LoadSavePlugin
{
	Q_OBJECT
...
extern "C" PLUGIN_API ScPlugin* importvsd_getPlugin();
extern "C" PLUGIN_API void importvsd_freePlugin(ScPlugin* plugin);
