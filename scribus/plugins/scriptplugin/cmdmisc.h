...
PyDoc_STRVAR(scribus_xfontnames__doc__,
    ...
    Returns a list of the tuples with: \
...
PyDoc_STRVAR(scribus_renderfont__doc__,
    "rendeFont()\n\n\
    Creates an image preview of font with given text");
...
PyDoc_STRVAR(scribus_layervisible__doc__,
    "setLayerVisible(layer, bool)\n\n\
    Sets the Layer \"layer\" to be visible or not. A Value of 1\
    for \"flag\" means that the Layer \"layer\" is visible,\
    a Value of 0 means that the Layer \"layer\" is invisible.");
/*! Set layer visible */
PyObject *scribus_layervisible(PyObject *self, PyObject* args);

/*! docstring */
PyDoc_STRVAR(scribus_layerprint__doc__,
    "setLayerPrintable(layer, bool)\n\n\
    Sets the Layer \"layer\" to be printable or not. A Value of 1 for\
    \"flag\" means that the Layer \"layer\" can be printed, a Value\
    of 0 means that printing the Layer \"layer\" is disabled.");
/*! Set layer printable */
...
PyDoc_STRVAR(scribus_glayervisib__doc__,
    ...
    of 1 means that the Layer \"layer\" is visible, a Value of 0\
...
PyDoc_STRVAR(scribus_glayerprint__doc__,
    ...
    a Value of 1 means that the Layer \"layer\" can be printed,\
    a Value of 0 means that printing the Layer \"layer\"\
    is disabled.");
/*! Set layer printable */
...
PyDoc_STRVAR(scribus_removelayer__doc__,
    "deleteLayer(layer)\n\n\
    Deletes the Layer with the Name \"name\". Nothing happens\
