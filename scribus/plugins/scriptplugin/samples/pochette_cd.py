...
if NewDoc(Paper_A4, Margins, 1, 1, 1, NoFacingPages, FirstPageLeft):
	...
	SetText("Gabarit de pochette de CD - Face arrière", a2)
	SetFontSize(11, a2)
	...
	SetText("Utilisez soit les blocs texte sur le calque Normal, soit les blocs images sur le calque Bords perdus. Bien sûr, il est possible de combiner les deux et /ou de modifier les types de blocs (convertir un bloc image en bloc texte ...).Le principe du bord perdu consiste à imprimer légèrement au delà du format final, pour recouper ensuite en étant sûr de n'avoir aucunes marges.Utilisez ensuite les traits de coupe pour découper précisément la pochette du CD, les traits au centre représentant le pliage.", a21)
	SetFontSize(11, a21)
