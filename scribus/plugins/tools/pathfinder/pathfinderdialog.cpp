...
PathFinderDialog::PathFinderDialog(QWidget* parent, ScribusDoc* doc, PageItem *shape1, PageItem *shape2) : QDialog( parent )
{
	...
	opExclusion->setIcon(QIcon(IconManager::instance().loadIcon("path-exclusion")));
	opIntersection->setIcon(QIcon(IconManager::instance().loadIcon("path-intersection")));
	opParts->setIcon(QIcon(IconManager::instance().loadIcon("path-parts")));
	opSubtraction->setIcon(QIcon(IconManager::instance().loadIcon("path-subtraction")));
	opCombine->setIcon(QIcon(IconManager::instance().loadIcon("path-unite")));
