...
void Mpalette::UnitChange()
{
  ...
  DRight->setDecimals(10);
	...
	Xpos->setMaxValue( QMAX(doc->PageB, doc->PageH) * UmReFaktor );
	Xpos->setMinValue( -3000 );
	Ypos->setMaxValue( QMAX(doc->PageB, doc->PageH) * UmReFaktor );
	Ypos->setMinValue( -3000 );
	Width->setMaxValue( QMAX(doc->PageB, doc->PageH) * UmReFaktor );
	Width->setMinValue( 1 );
	Height->setMaxValue( QMAX(doc->PageB, doc->PageH) * UmReFaktor );
	Height->setMinValue( 1 );
