...
public:
	...
	QValueList<QString> fontNames() const      { return m_fonts.keys(); }
	QValueList<QString> patternNames() const   { return m_patterns.keys(); }
	QValueList<QString> colorNames() const     { return m_colors.keys(); }
	QValueList<QString> styleNames() const     { return m_pstyles.keys(); }
	QValueList<QString> charStyleNames() const { return m_cstyles.keys(); }
	QValueList<QString> lineStyleNames() const { return m_linestyles.keys(); }
