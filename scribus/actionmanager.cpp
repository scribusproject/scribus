...
void ActionManager::initFileMenuActions()
{
	...
	scrActions->insert(name, new ScrAction(QIconSet(loadIcon("acroread16.png"),loadIcon("acroread22.png")), "", defKeys[name], mainWindow, name));
	//Rest of File Menu
	name="fileDocSetup";
	...
	name="PrintPreview";
	scrActions->insert(name, new ScrAction(QIconSet(loadIcon("16/document-print-preview.png"), loadIcon("22/document-print-preview.png")), "", defKeys[name], mainWindow, name));
	name="fileQuit";
...
void ActionManager::initToolsMenuActions()
{
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt,QIconSet(loadIcon("16/insert-image.png"), loadIcon("22/insert-image.png")), "", defKeys[name], mainWindow, name, modeDrawPicture));
	name="toolsInsertTableFrame";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt,QIconSet(loadIcon("16/insert-table.png"), loadIcon("22/insert-table.png")), "", defKeys[name], mainWindow, name, modeDrawTable));
...
void ActionManager::initHelpMenuActions()
{
	...
	scrActions->insert(name, new ScrAction("", defKeys[name], mainWindow, name));
	name="helpManual";
	scrActions->insert(name, new ScrAction(loadIcon("16/help-browser.png"), "", defKeys[name], mainWindow, name));
