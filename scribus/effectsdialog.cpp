...
void EffectsDialog::selectEffect(QListWidgetItem* c)
{
	...
	if (c)
	{
		...
		else if (c->text() == tr("Duotone"))
		{
			...
			fp >> shading1;
			fp >> shading2;
			colData1->setEditText(col1);
			shade1->setValue(shading1);
			colData2->setEditText(col2);
		...
		else if (c->text() == tr("Tritone"))
		{
			...
			fp >> shading2;
			fp >> shading3;
			colDatat1->setEditText(col1);
			shadet1->setValue(shading1);
			colDatat2->setEditText(col2);
			shadet2->setValue(shading2);
			colDatat3->setEditText(col3);
		...
		else if (c->text() == tr("Quadtone"))
		{
			...
			fp >> shading3;
			fp >> shading4;
			colDataq1->setEditText(col1);
			shadeq1->setValue(shading1);
			colDataq2->setEditText(col2);
			shadeq2->setValue(shading2);
			colDataqc3->setEditText(col3);
			shadeqc3->setValue(shading3);
			colDataq4->setEditText(col4);
