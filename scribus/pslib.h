...
class SCRIBUS_API PSLib : public QObject
{
	...
	public:
		...
		virtual int CreatePS(ScribusDoc* Doc, std::vector<int> &pageNs, bool sep, QString SepNam, QStringList spots, bool farb, bool Hm, bool Vm, bool Ic, bool gcr, bool doDev);
