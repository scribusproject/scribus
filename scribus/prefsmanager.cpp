...
bool PrefsManager::WritePref(QString ho)
{
	...
	dc76.setAttribute("RANDO",appPrefs.margins.Top);
	...
	dc76.setAttribute("BleedTop", appPrefs.bleeds.Top);
	dc76.setAttribute("BleedLeft", appPrefs.bleeds.Left);
	dc76.setAttribute("BleedRight", appPrefs.bleeds.Right);
...
//		pgst.setAttribute("GapBelow", (*itpgset).GapBelow);
	...
	pdf.setAttribute("BTop", appPrefs.PDF_Options.bleeds.Top);
	pdf.setAttribute("BLeft", appPrefs.PDF_Options.bleeds.Left);
	pdf.setAttribute("BRight", appPrefs.PDF_Options.bleeds.Right);
	pdf.setAttribute("BBottom", appPrefs.PDF_Options.bleeds.Bottom);
