...
*/
#ifndef PRINTPREVIEWCREATOR_PDF_H
#define PRINTPREVIEWCREATOR_PDF_H
...
class PrefsManager;
class ScribusDoc;
class ScPrintEngine_PDF;

class SCRIBUS_API PrintPreviewCreator_PDF : public SeparationPreviewCreator
{
public:
	PrintPreviewCreator_PDF(ScribusDoc* doc);
	~PrintPreviewCreator_PDF();
...
protected:
	...
	ScPrintEngine_PDF* m_pdfPrintEngine { nullptr };
