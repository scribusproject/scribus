...
// Qt4	bleedTop->setMinValue(0);
// Qt4	bleedTop->setMaxValue(3000*unitRatio);
	bleedTop->setSuffix(unitSuffix);
	bleedBottom->setDecimals( decimals );
// Qt4	bleedBottom->setMinValue(0);
// Qt4	bleedBottom->setMaxValue(3000*unitRatio);
	bleedBottom->setSuffix(unitSuffix);
	bleedLeft->setDecimals( decimals );
// Qt4	bleedLeft->setMinValue(0);
// Qt4	bleedLeft->setMaxValue(3000*unitRatio);
	bleedLeft->setSuffix(unitSuffix);
	bleedRight->setDecimals( decimals );
// Qt4	bleedRight->setMinValue(0);
// Qt4	bleedRight->setMaxValue(3000*unitRatio);
	bleedRight->setSuffix(unitSuffix);
	offsetValue->setDecimals( decimals );
// Qt4	offsetValue->setMinValue(0);
// Qt4	offsetValue->setMaxValue(3000*unitRatio);
