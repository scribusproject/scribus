...
*/
#ifndef PALETTELOADER_AUTOCAD_ACB_H
#define PALETTELOADER_AUTOCAD_ACB_H
...
class PaletteLoader_Autocad_acb : public PaletteLoader
{
public:
	PaletteLoader_Autocad_acb() = default;
