...
1.4.1 is the new stable Scribus version, released April 30 2012.

While 1.4.1 is considered to be usable in production, if you have documents made in 1.3.3.x, you may want to keep the latest 1.3.3.14 as a fallback option for older documents due to some changes in layout. 
...
If you think you have found a bug in 1.4.1, you can use the Scribus bugtracker (http://bugs.scribus.net) to make us aware of it. Please make sure that the bug hasn't been reported earlier. The bugtracker's search feature can help you to check for issues that have already been submitted.
